...
public class CrackTransformer implements MyTransformer {
    ...
    public String getHookClassName() {
        return "com/ccnode/codegenerator/Y/f/a";
    }
        ...
        try {
            ...
            // 添加依赖
            {
                ...
                if (!Objects.equals(pluginDescriptor.getClass()
                        .getDeclaredMethod("getVersion").invoke(pluginDescriptor), "3.2.4")) {
                    System.err.println("目前仅支持 3.2.4 版本 https://plugins.jetbrains.com/plugin/9837-mybatiscodehelperpro/versions/stable/384759");
                    return classBytes;
                }
            ...
            clazz.addMethod(CtMethod.make("public static com.ccnode.codegenerator.Y.e.e a (java.lang.String s){ " +
                            "com.ccnode.codegenerator.Y.e.e a = a0(s);" +
                            // paidKey
